...
function EFFECT:Init(data)
    ...
    local AddVelgasax = Vector(0, 0, 5)
	...
	local flashCount = math.Round(self.FlashSize * 8)
	    ...
	    for _ = 1, flashCount do
		    ...
		    if (particle) then
				local rgbrand = math.random(100, 195)
				...
				particle:SetColor(rgbrand, rgbrand, rgbrand)
	    ...
	    for _ = 11, 11 do
		    ...
		    if (particle) then
				local rgbrand = math.random(100, 195)
			    particle:SetVelocity(dir * 100 * self.FlashSize + 1 * AddVelgasax)
			    particle:SetLifeTime(0)
			    particle:SetDieTime(self.Life * 15)
			    particle:SetStartAlpha(math.Rand(5, 35))
			    particle:SetEndAlpha(0)
			    particle:SetStartSize(1 * math.Rand(0.8, 1.5) * self.FlashSize)
