...
ATTACHMENT.Name = "Leupold M3A ULTRA"
ATTACHMENT.Description = { TFA.AttachmentColors["="], "7x zoom", TFA.AttachmentColors["-"], "30% higher zoom time",  TFA.AttachmentColors["-"], "5% slower aimed walking" }
ATTACHMENT.Icon = "entities/saa_leupold.png"
ATTACHMENT.ShortName = "M3A"
...
ATTACHMENT.WeaponTable = {
	...
	["IronSightsPos"] = function( wep, val ) return wep.IronSightsPos_leupold or val end,
	["IronSightsAng"] = function( wep, val ) return wep.IronSightsAng_leupold or val end,
	...
	["SWEP.DrawCrosshair"] = function( wep, val )return false end,	
...
function ATTACHMENT:Attach(wep)
	...
	wep.RTCode = function( myself , rt, scrw, scrh)
		...
		if not myshad then
			myshad = Material( "models/weapons/tfa_ins2/optics/mk4_crosshair")
		end
