...
ATTACHMENT.Icon = "entities/saa_1p29.png" --Revers to label, please give it an icon though!  This should be the path to a png, like "entities/tfa_ammo_match.png"
ATTACHMENT.ShortName = "USP-1"
local usp1 = Vector(0, 0, -1)
ATTACHMENT.WeaponTable = {
	...
	["VMPos"] = function(wep,val ) return wep.VMPos + usp1 or val end,
	["CrouchPos"] = function(wep,val ) return wep.CrouchPos + usp1 or val end,
	["IronSightsPos"] = function( wep, val ) return wep.IronSightsPos_1p29 or val end,
	["IronSightsAng"] = function( wep, val ) return wep.IronSightsAng_1p29 or val end,
	...
	["Secondary"] = {
		...
		["ScopeZoom"] = function( wep, val ) return 3.6 end
	},
...
function ATTACHMENT:Attach(wep)
	...
	wep.RTCode = function( myself , rt, scrw, scrh)
		...
		if not myshad then
			myshad = Material( "models/weapons/optics/1p29")
		end
