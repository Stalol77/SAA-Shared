...
ATTACHMENT.Name = "1P78-1 Kashtan"
--ATTACHMENT.ID = "base" -- normally this is just your filename
ATTACHMENT.Description = { TFA.AttachmentColors["="], "2.8x magnification", TFA.AttachmentColors["="], "5.45mm, 7.62mm",  TFA.AttachmentColors["-"], "20% higher zoom time",  TFA.AttachmentColors["-"], "5% slower aimed walking" }
ATTACHMENT.Icon = "entities/saa_1p78.png" --Revers to label, please give it an icon though!  This should be the path to a png, like "entities/tfa_ammo_match.png"
ATTACHMENT.ShortName = "1P78-1"
local v1p78 = Vector(0, 0, -1.5)
ATTACHMENT.WeaponTable = {
	...
	["VMPos"] = function(wep,val ) return wep.VMPos + v1p78 or val end,
	["IronSightsPos"] = function( wep, val ) return wep.IronSightsPos_1p78 or val end,
	["IronSightsAng"] = function( wep, val ) return wep.IronSightsAng_1p78 or val end,
	...
	["Secondary"] = {
		...
		["ScopeZoom"] = function( wep, val ) return 2.8 end
	},
...
function ATTACHMENT:Attach(wep)
	...
	wep.RTCode = function( myself , rt, scrw, scrh)
		...
		if not myshad then
			myshad = Material( "models/weapons/optics/kashtan_reticule")
		end
