...
ATTACHMENT.Description = { TFA.AttachmentColors["="], "4x zoom", TFA.AttachmentColors["="], "За Сталина!", TFA.AttachmentColors["-"], "30% higher zoom time",  TFA.AttachmentColors["-"], "5% slower aimed walking" }
ATTACHMENT.Icon = "entities/saa_pu.png" --Revers to label, please give it an icon though!  This should be the path to a png, like "entities/tfa_ammo_match.png"
...
ATTACHMENT.WeaponTable = {
	...
	["IronSightsPos"] = function( wep, val ) return wep.IronSightsPos_PU4 or val end,
	["IronSightsAng"] = function( wep, val ) return wep.IronSightsAng_PU4 or val end,
...
function ATTACHMENT:Attach(wep)
	...
	wep.RTCode = function( myself , rt, scrw, scrh)
		...
		if not myshad then
			myshad = Material( "models/weapons/tfa_ins2/optics/mosin_crosshair")
		end
