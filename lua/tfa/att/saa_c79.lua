...
ATTACHMENT.Name = "C79 Elcan Scope"
...
ATTACHMENT.Icon = "entities/saa_c79.png" --Revers to label, please give it an icon though!  This should be the path to a png, like "entities/tfa_ammo_match.png"
...
ATTACHMENT.WeaponTable = {
	...
	["Secondary"] = {
		["IronFOV"] = function( wep, val ) return wep.Secondary.IronFOV_c79 or val * 0.7 end,
	...
	["RTScopeFOV"] = function(wep, val) return (wep.RTScopeFOV_c79 or wep:GetStat("Secondary.IronFOV")) / wep:GetStat("Secondary.ScopeZoom") / 3.4 end,
	["RTOpaque"] = -1,
...
function ATTACHMENT:Attach(wep)
	...
	wep.RTCode = function( myself , rt, scrw, scrh)
		...
		if not myshad then
			myshad = Material( "models/weapons/tfa_ins2/optics/elcan_reticule")
		end
