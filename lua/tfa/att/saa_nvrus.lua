...
ATTACHMENT.WeaponTable = {
	...
	["RTScopeFOV"] = function(wep, val) return (wep.RTScopeFOV_1pn93 or wep:GetStat("Secondary.IronFOV")) / wep:GetStat("Secondary.ScopeZoom") / 4 end,
	["RTOpaque"] = -1,
...
function ATTACHMENT:Attach(wep)
	...
	wep.RTCode = function( myself , rt, scrw, scrh)
		...
		if not myshad then
			myshad = Material( "models/weapons/optics/1pn93_4_off")
		end
