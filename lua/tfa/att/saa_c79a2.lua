...
ATTACHMENT.Name = "C79A2 Elcan Scope"
...
ATTACHMENT.Icon = "entities/saa_c79a2.png" --Revers to label, please give it an icon though!  This should be the path to a png, like "entities/tfa_ammo_match.png"
